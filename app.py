...
import openai
llm = OpenAI(openai_api_key = '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', temperature=0.2)
...
if pdf_file is not None:
    ...
    if page_selection == "Single page":
        ...
        texts = text_splitter.split_text(combined_content)
        embedding = OpenAIEmbeddings(openai_api_key = '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')
