...
import openai
llm = OpenAI(openai_api_key = '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', temperature=0.2)
...
if pdf_file is not None:
    ...
    if page_selection == "Single page":
        ...
        texts = text_splitter.split_text(combined_content)
        embedding = OpenAIEmbeddings(openai_api_key = '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')
