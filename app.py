...
import openai
llm = OpenAI(openai_api_key = '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', temperature=0.2)
...
if pdf_file is not None:
    ...
    if page_selection == "Single page":
        ...
        texts = text_splitter.split_text(combined_content)
        embedding = OpenAIEmbeddings(openai_api_key = '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')
